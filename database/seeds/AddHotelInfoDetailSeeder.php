...
class AddHotelInfoDetailSeeder extends Seeder
{
    ...
    public function run()
    {
         DB::table('hotel_info_detail')->insert([ 
         	['hotel_id'=>1,'hotel_info_id'=>3,'description'=>' Nằm tại thành phố Đà Nẵng, cách Bãi biển Mỹ Khê 100 m, Sala Danang Beach Hotel có nhà hàng, chỗ đỗ xe riêng miễn phí, xe đạp cho khách sử dụng miễn phí và hồ bơi ngoài trời. Các tiện nghi của chỗ nghỉ bao gồm trung tâm thể dục, quán bar và phòng khách chung. Chỗ nghỉ cũng cung cấp dịch vụ lễ tân 24 giờ, dịch vụ phòng và dịch vụ thu đổi ngoại tệ cho khách.</br>
         		Phòng nghỉ tại khách sạn được trang bị máy điều hòa, TV màn hình phẳng với truyền hình cáp, ấm đun nước, chậu rửa vệ sinh (bidet), máy sấy tóc và bàn làm việc. Ngoài ra, phòng còn có WiFi miễn phí, phòng tắm riêng với vòi sen và đồ vệ sinh cá nhân miễn phí cùng khu vực ghế ngồi.</br>
         			Chỗ nghỉ phục vụ bữa sáng tự chọn.Sala Danang Beach Hotel có sân hiên.</br>
         	...
         	['hotel_id'=>2,'hotel_info_id'=>3,'description'=>'Chicland mở cửa vào ngày 01/6/2019, là khách sạn 4 sao về vật chất, 5 sao về chất lượng dịch vụ bao gồm 133 phòng và 17 căn hộ.  Phần lớn tất cả các dịch vụ đều sử dụng các nguyên vật liệu có thể  tái sử dụng, dễ phân hủy và thân thiện với môi trường.</br>
         	...
         	Furama Resort Danang tọa lạc ở phường Bắc Mỹ An. Từ đây đến thương cảng “Con đường Tơ lụa” cổ kính của Hội An mất 30 phút lái xe và Thánh Địa Mỹ Sơn cách đó chưa đến 2 giờ.</br>
         	Tất cả các phòng gắn máy điều hòa rộng rãi tại đây đều được thiết kế trang nhã và có ban công riêng nhìn ra quang cảnh nhiệt đới. Trong phòng có sàn gỗ và thảm thanh lịch cùng tủ quần áo không cửa ngăn, không gian tiếp khách rộng rãi cùng phòng tắm lớn lát đá cẩm thạch.</br>
         	Furama cung cấp các liệu pháp làm đẹp và spa sang trọng bao gồm nhiều phong cách mát-xa và chăm sóc da mặt. Khách có thể thư giãn với phòng xông hơi ướt và xông hơi khô hoặc tận hưởng dịch vụ mát-xa bên hồ bơi.</br>
         	...
         	Tất cả phòng nghỉ tại đây đều được trang bị máy điều hòa, TV màn hình phẳng với truyền hình cáp, ấm đun nước, vòi sen, máy sấy tóc và bàn làm việc. Ngoài ra, phòng còn có tủ để quần áo và phòng tắm riêng.</br>
         	Rosamia Da Nang Hotel phục vụ bữa sáng kiểu lục địa.</br>
