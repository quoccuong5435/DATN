					...
					<div class="tour_head1 hotel-book-room">
						...
						<div id="myCarousel1" class="carousel slide" data-ride="carousel">
							...
							<ol class="carousel-indicators carousel-indicators-1">
								<li data-target="#myCarousel1" data-slide-to="0"><img src="{{ asset('source/images/gallery/s1.jpg') }}" alt="Chania">
								</li>
								<li data-target="#myCarousel1" data-slide-to="1"><img src="{{ asset('source/images/gallery/s2.jpg') }}" alt="Chania">
								</li>
								<li data-target="#myCarousel1" data-slide-to="2"><img src="{{ asset('source/images/gallery/s3.jpg') }}" alt="Chania">
								</li>
								<li data-target="#myCarousel1" data-slide-to="3"><img src="{{ asset('source/images/gallery/s4.jpg') }}" alt="Chania">
								</li>
								<li data-target="#myCarousel1" data-slide-to="4"><img src="{{ asset('source/images/gallery/s5.jpg') }}" alt="Chania">
								</li>
								<li data-target="#myCarousel1" data-slide-to="5"><img src="{{ asset('source/images/gallery/s6.jpg') }}" alt="Chania">
								</li>
								<li data-target="#myCarousel1" data-slide-to="6"><img src="{{ asset('source/images/gallery/s7.jpg') }}" alt="Chania">
								</li>
								<li data-target="#myCarousel1" data-slide-to="7"><img src="{{ asset('source/images/gallery/s8.jpg') }}" alt="Chania">
								</li>
								<li data-target="#myCarousel1" data-slide-to="8"><img src="{{ asset('source/images/gallery/s9.jpg') }}" alt="Chania">
								</li>
							</ol>
							<!-- Wrapper for slides -->
							<div class="carousel-inner carousel-inner1" role="listbox">
								<div class="item active"> <img src="{{ asset('source/images/gallery/s1.jpg') }}" alt="Chania" width="460" height="345"> </div>
								<div class="item"> <img src="{{ asset('source/images/gallery/s2.jpg') }}" alt="Chania" width="460" height="345"> </div>
								<div class="item"> <img src="{{ asset('source/images/gallery/s3.jpg') }}" alt="Chania" width="460" height="345"> </div>
								<div class="item"> <img src="{{ asset('source/images/gallery/s4.jpg') }}" alt="Chania" width="460" height="345"> </div>
								<div class="item"> <img src="{{ asset('source/images/gallery/s5.jpg') }}" alt="Chania" width="460" height="345"> </div>
								<div class="item"> <img src="{{ asset('source/images/gallery/s6.jpg') }}" alt="Chania" width="460" height="345"> </div>
								<div class="item"> <img src="{{ asset('source/images/gallery/s7.jpg') }}" alt="Chania" width="460" height="345"> </div>
								<div class="item"> <img src="{{ asset('source/images/gallery/s8.jpg') }}" alt="Chania" width="460" height="345"> </div>
								<div class="item"> <img src="{{ asset('source/images/gallery/s9.jpg') }}" alt="Chania" width="460" height="345"> </div>
							</div>
