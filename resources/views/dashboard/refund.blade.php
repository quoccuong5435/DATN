				...
				<div class="db-2-com db-2-main">
					...
					<div class="db-2-main-com db-2-main-com-table db-com-p">
						...
						<div class="db-mak-pay-bot">
							<p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters</p> <a href="{{ route('db-makepayment') }}" class="waves-effect waves-light btn-large">Make Paymeny Now</a> </div>
					</div>
				</div>
			</div>
