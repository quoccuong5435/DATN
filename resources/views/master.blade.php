...
<link type="text/css" rel="stylesheet" href="{{ asset('source/css/JFFormStyle-1.css') }}" />
<!-- js -->
<script src="{{ asset('source/js/jquery.min.js') }}"></script>
<script src="{{ asset('source/js/modernizr.custom.js') }}"></script>
<!-- //js -->
<!-- fonts -->
...
<!--pop-up-->
<script src="{{ asset('source/js/menu_jquery.js') }}"></script>
<!--//pop-up-->	
</head>
<body>
	<!--header-->
		...
		<div class="container">
				<div class="footer-bottom-top-grids">
					<div class="col-md-4 footer-bottom-left">
						...
						<div class="d-apps">
							<ul>
								<li><a href="#"><img src="{{ asset('source/images/app1.png') }}" alt="" /></a></li>
								<li><a href="#"><img src="{{ asset('source/images/app2.png') }}" alt="" /></a></a></li>
								<li><a href="#"><img src="{{ asset('source/images/app3.png') }}" alt="" /></a></a></li>
							</ul>
						</div>
					</div>
					<div class="col-md-4 footer-bottom-left">
						...
						<div class="a-cards">
							<ul>
								<li><a href="#"><img src="{{ asset('source/images/c1.png') }}" alt="" /></a></li>
								<li><a href="#"><img src="{{ asset('source/images/c2.png') }}" alt="" /></a></a></li>
								<li><a href="#"><img src="{{ asset('source/images/c3.png') }}" alt="" /></a></a></li>
							</ul>
						</div>
					</div>
					<div class="col-md-4 footer-bottom-left">
	...
	<script type="text/javascript" src="{{ asset('source/js/script.js') }}"></script>
	<script type="text/javascript">
		$(function(){
