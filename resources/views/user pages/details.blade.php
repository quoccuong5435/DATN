				...
				<div class="single-page">
						<div class="col-md-8 single-gd-lt">
							...
							<div class="flexslider">
											<ul class="slides">
												<li data-thumb="{{ asset('source/images/p1.jpg') }}">
													<img src="{{ asset('source/images/p1.jpg') }}" alt=""/>
												</li>
												<li data-thumb="{{ asset('source/images/p2.jpg') }}">
													<img src="{{ asset('source/images/p2.jpg') }}" alt=""/>
												</li>
												<li data-thumb="{{ asset('source/images/p3.jpg') }}">
													<img src="{{ asset('source/images/p3.jpg') }}" alt=""/>
												</li>
												<li data-thumb="{{ asset('source/images/p4.jpg') }}">
													<img src="{{ asset('source/images/p4.jpg') }}" alt=""/>
												</li>
												<li data-thumb="{{ asset('source/images/p1.jpg') }}">
													<img src="{{ asset('source/images/p1.jpg') }}" alt=""/>
												</li>
					...
					<div class="p-table-grids">
						<div class="col-md-3 p-table-grid">
							...
							<div class="p-table-grid-info">
								<a href="#"><img src="{{ asset('source/images/p2.jpg') }}" alt=""></a>
				...
				<div class="p-table">
					<div class="p-table-grids">
						<div class="col-md-3 p-table-grid">
							...
							<div class="p-table-grid-info">
								<a href="#"><img src="{{ asset('source/images/p1.jpg') }}" alt=""></a>
								<div class="room-basic-info">
									<a href="#">Fusce vestibulum ultricies rutrum</a>
									<h6>1 king bed or  2 single beds</h6>
									<p>Vestibulum ullamcorper(condimentum luctus)</p>
